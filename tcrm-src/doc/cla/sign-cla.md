...
In order for your contribution to tcrm to be accepted, you have to sign the
tcrm Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [tcrm/tcrm](https://github.com/tcrm/tcrm), adding a new file
...
I hereby agree to the terms of the tcrm Individual Contributor License
Agreement v1.0.
...
3. An tcrm R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [tcrm/tcrm](/tcrm/tcrm), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is tcrm, the file would be
    `doc/cla/corporate/tcrm.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the tcrm Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `tcrm.com`.  In that case someone from the tcrm team will
make the pull request on your behalf.

* Printable tcrm CCLA v1.0 https://www.tcrm.com/files/legal/tcrm-CCLA-v1.0.pdf
* Printable tcrm ICLA v1.0 https://www.tcrm.com/files/legal/tcrm-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for tcrm is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the tcrm project

* protect the tcrm project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the tcrm project and its users from bad actors who would contribute
...
contributor really intended to contribute to the tcrm project under specific
...
The tcrm CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, tcrm S.A. to use, modify and
...
(ICLA) of tcrm.  The agreement is executed by adding your name and

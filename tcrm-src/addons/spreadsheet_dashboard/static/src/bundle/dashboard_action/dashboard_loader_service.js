...
export class DashboardLoader {
    ...
    _createSpreadsheetModel(snapshot, revisions = [], currency, translationNamespace) {
        const tcrmDataProvider = new tcrmDataProvider(this.env);
        const model = new Model(
            snapshot,
            {
                custom: { env: this.env, orm: this.orm, tcrmDataProvider, translationNamespace },
                mode: "dashboard",
        ...
        tcrmDataProvider.addEventListener("data-source-updated", () =>

...
import { after, describe, expect, mockFetch, test } from "@tcrm/hoot";
...
describe(parseUrl(import.meta.url), () => {
    ...
    test("fetch with internal URLs should return default value", async () => {
        ...
        const internal = await fetch("/tcrm").then((res) => res.text());
        ...
        expect.verifySteps(["http://some.url", "/tcrm", "data:text/html,<body></body>"]);
    });
